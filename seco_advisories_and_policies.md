...
send to the r-packages mailing-list(https://stat.ethz.ch/mailman/listinfo/r-packages)[^3](#3), r-help mailing-list has been active since late 90's and is still very active.<br>
...
[3] <a name="3"></a> http://r-pkgs.had.co.nz/release.html#promotion<br>
